...
/**
 * Created by sampson on 2017/8/23.
 */
...
public class FileImageUpload {
     ...
     * @return &#x8fd4;&#x56de;&#x54cd;&#x5e94;&#x7684;&#x5185;&#x5bb9;
     */
    public static String uploadFile(Bitmap file, String RequestURL) {
        String fileName = "sign";

        Log.e(TAG, "上传图片url:"+RequestURL);
        ...
        try {
            ...
            if(file!=null) {
                 ...
                 */
                sb.append("Content-Disposition: form-data; name=\"sign\"; filename=\""+ "1234.png" +"\""+LINE_END);
