...
import com.lvgou.qdd.http.session.PostStringRequest;
...
/****************************************添加了session***********************************************/
    public  void getRequest(final Context context){
        ...
        PostStringRequest request = new PostStringRequest(url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Logger.getInstance(context).info(response);
    ...
    public  void postRequest(final Context context, final Map<String,String> params){
        mQueue = Volley.newRequestQueue(context);
        PostStringRequest request = new PostStringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
